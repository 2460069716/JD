...
if __name__ == '__main__':
    ...
    x = torch.randn(1, 12, 4, 128, 128).to(device)
    model = SimVP_Model(in_shape=[12, 4, 128, 128],model_type='tau',N_S=4,N_T=8).to(device)
    summary(model, input_size=x.shape, device=device.type)